...
const Landing = () => {
  return (
    <div className='flex flex-col gap-20 pt-8 overflow-hidden md:py-8 md:pl-12 md:gap-28'>
      <div className="relative flex flex-col items-center gap-5 text-center md:justify-evenly md:gap-48 md:items-center md:flex-row md:text-start">
      ...
      <div className='flex flex-wrap items-center justify-center gap-8 text-center md:justify-evenly md:gap-48 md:text-start'>
      ...
      <div className="relative flex flex-col-reverse flex-wrap items-center justify-center gap-8 text-center md:flex-row md:justify-evenly md:gap-48 md:text-start ">
      <ImageSlideShow slides={slides} />
